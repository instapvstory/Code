...
export const metadata = {
  title: 'Disclaimer - PvStoryViewer',
  description: 'Legal disclaimer for PvStoryViewer services and content.',
};
    ...
    <main className={styles.legalPage}>
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <p>The information and services provided by PvStoryViewer are for general informational purposes only. By using this website, you acknowledge and agree to the following terms.</p>

          <h2>1. Independent Entity Status</h2>
          <p>PvStoryViewer is an independently operated web-based research tool. We are not affiliated, associated, authorized, endorsed by, or in any way officially connected with Instagram, Meta Platforms, Inc., or any of its subsidiaries or affiliates. Our service operates as a separate discovery layer for publicly available digital content.</p>
          ...
          <p>PvStoryViewer utilizes advanced discovery protocols to retrieve real-time public data. However, we make no representations or warranties regarding the absolute completeness or 24/7 accuracy of the information provided. Data is processed "as is," and its availability depends on the stability of official discovery channels and third-party infrastructure.</p>

          <h2>4. User Conduct & Compliance</h2>
          <p>By utilizing our discovery engine, you agree to assume full responsibility for your actions. PvStoryViewer is designed for ethical market research, creative monitoring, and personal anonymity. We explicitly disclaim any liability for the misuse of information obtained through our system, including any activities that violate the privacy expectations of content creators.</p>

          <h2>5. Professional Disclaimer</h2>
          <p>The information provided through PvStoryViewer does not constitute legal, professional, or technical advice. Users are encouraged to conduct their own due diligence when using public social data for business, legal, or investigative purposes.</p>
