...
export const metadata = {
  title: 'Terms of Service - InstaPvStory',
  description: 'Terms and conditions for using the InstaPvStory anonymous Instagram viewer.',
};
    ...
    <main className={styles.legalPage}>
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <p>Welcome to InstaPvStory. By accessing or using our website, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you must not use our services.</p>

          <h2>1. Acceptable Use Policy</h2>
          <p>InstaPvStory is intended for professional market research, creative inspiration, and personal privacy analysis. By using this service, you warrant that your discovery activities are in compliance with your local laws. Prohibited activities include, but are not limited to:</p>
          <ul>
          ...
          <p>InstaPvStory does not own the content displayed through our discovery engine. All media, including stories, reels, and photos, are the property of their respective creators and the platforms that host them. We provide a transient viewing interface for publicly available data. Users are responsible for ensuring that their viewing activities respect the intellectual property rights of content owners.</p>
          ...
          <p>InstaPvStory, its developers, and its affiliates shall not be liable for any damages—direct or indirect—arising from the use of our discovery technology. This includes, but is not limited to, data inaccuracies, loss of research, or any legal consequences resulting from your use of publicly available information. You use this system entirely at your own risk.</p>
